 ...
 * @author Abhishek
 */
public class ManageLocalityRequestJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageLocalityRequestJPanel
     */
    private JPanel userProcessContainer;
    private Enterprise enterprise;
    private UserDetails userAccount;
    private EcoSystem ecoSystem;
    public ManageLocalityRequestJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDirectory,Enterprise enterprise,UserDetails userAccount,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Police Manage Request From Locality");
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        if(selectedRow<0){
            ...
            LocalityPoliceRequest c =  (LocalityPoliceRequest)tblRequest.getValueAt(selectedRow, 7);
    ...
    private void btnApproveReqPoliceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveReqPoliceActionPerformed
        ...
        if(selectedRow<0){
            ...
            LocalityPoliceRequest p=(LocalityPoliceRequest) tblRequest.getValueAt(selectedRow, 7);
...
//                    }
                    ...
                    for(PoliceDepartment v : ecoSystem.getPoliceDepartmentList().getPoliceDepartmentList()) {
    ...
    private void populateRequestTable(){
        ...
        for(WorkRequest work : ecoSystem.getWorkQueue().getWorkRequestList()){
            if(work instanceof LocalityPoliceRequest){
                
                 if(((LocalityPoliceRequest) work).getReceiver() == null || ((LocalityPoliceRequest) work).getReceiver() == userAccount ){
                ...
                if(((LocalityPoliceRequest) work).getReceiver() != null){
                    row[9] = ((LocalityPoliceRequest) work).getReceiver();
                }
