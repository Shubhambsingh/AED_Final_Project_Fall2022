...
public class ManageLocalityRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblAvailableFire.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Incident Department Group", "Group Strength"
            }
        ) {
        ...
        jLabel1.setText("Incident Department Request From Locality");

        jLabel5.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel5.setText("Incident Department Data");
        ...
        jLabel2.setText("Incident person to be allocated");
    ...
    private void btnApproveReqPoliceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveReqPoliceActionPerformed
        ...
        if(selectedRow<0){
            ...
            LocalityFireRequest p=(LocalityFireRequest) tblRequest.getValueAt(selectedRow, 7);
            ...
            if(p.getReceiver()!= null){
                if (p.getStatus().equalsIgnoreCase("Pending")) {
                    ...
                    for(IncidentDepartment v : ecoSystem.getIncidentDepartmentDirectory().getIncidentDepartmentList()) {
                        if(v.getIncidentDepartmentType().equals(p.getIncidentDepartmentType())){
                    ...
                    p.setIncidentDepartmentCount(Integer.parseInt(txtCount.getText()));
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        if(selectedRow<0){
            ...
            LocalityFireRequest c =  (LocalityFireRequest)tblRequest.getValueAt(selectedRow, 7);
    ...
    private void populateAvailableFireTbl() {
       ...
       System.out.print("check 1 !!!");
        ...
        for (IncidentDepartment fire : ecoSystem.getIncidentDepartmentDirectory().getIncidentDepartmentList() ) {
    ...
    private void populateRequestTable(){
        ...
        for(WorkRequest work : ecoSystem.getWorkQueue().getWorkRequestList()){
            if(work instanceof LocalityFireRequest){
                if(((LocalityFireRequest) work).getReceiver() == null || ((LocalityFireRequest) work).getReceiver() == userAccount ){
                ...
                if(((LocalityFireRequest) work).getReceiver() != null){
                    row[9] = ((LocalityFireRequest) work).getReceiver();
                }
