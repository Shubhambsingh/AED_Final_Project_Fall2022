...
public class ClinicAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public ClinicAdminWorkAreaJPanel(JPanel UserContainer, UserDetails userAccount, ClinicOrganization clinicOrganization, Enterprise enterprise, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Clinic-Medic Workplace");

        jButton1.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        jButton1.setText("Manage Medic");
        ...
        jButton2.setText("Manage Locality Request");
        ...
        jButton4.setText("Create Medic User");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 1377, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ClinicManageMedicsJPanel clinicManageMedicsJPanel = new ClinicManageMedicsJPanel(userProcessContainer, enterprise, ecoSystem, userAccount,enterprise.getOrganizationDirectory());
        userProcessContainer.add("HospitalManageMedicsJPanel", clinicManageMedicsJPanel);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        ClinicManageLocalityRequestJPanel clinicManageLocalityRequestJPanel = new ClinicManageLocalityRequestJPanel(userProcessContainer, enterprise.getOrganizationDirectory(), enterprise, ecoSystem, userAccount);
        userProcessContainer.add("ClinicManageLocalityRequestJPanel", clinicManageLocalityRequestJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        ClinicCreateMedicUser clinicCreateMedicUser = new ClinicCreateMedicUser(userProcessContainer, enterprise, ecoSystem, userAccount,enterprise.getOrganizationDirectory());
        userProcessContainer.add("ClinicCreateMedicUser", clinicCreateMedicUser);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
