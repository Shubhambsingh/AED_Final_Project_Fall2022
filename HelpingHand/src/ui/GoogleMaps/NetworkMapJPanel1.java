 ...
 * @author ShubhamSingh
 */
public class NetworkMapJPanel1 extends javax.swing.JPanel {
    ...
    public NetworkMapJPanel1( JPanel userProcessContainer,EcoSystem ecoSystem) {
        initComponents();
  ...
  private void init() {
        ...
        DefaultTileFactory tileFactory = new DefaultTileFactory(info);
        jXMapViewer.setTileFactory(tileFactory);
        GeoPosition geo = new GeoPosition(42.3142647,-71.1103682);
  ...
  private EventWaypoint getEvent() {
        return (MyWaypoint waypoint) -> {
            JOptionPane.showMessageDialog(NetworkMapJPanel1.this, waypoint.getName());
        };
    }
