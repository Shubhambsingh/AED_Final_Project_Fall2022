...
public class OrganizationMapJPanel extends javax.swing.JPanel {
    ...
    private void cmdAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddActionPerformed
        ...
        if (userProcessContainer.getComponent(componentArray.length - 1) instanceof SPManageOrganization) {
            ...
            orgManagement.populateLongituteLatitude(locationPoint);
              ...
              else if (userProcessContainer.getComponent(componentArray.length - 1) instanceof SetAreaJPanel) {
            SetAreaJPanel orgManagement = (SetAreaJPanel) userProcessContainer.getComponent(componentArray.length - 1);
            orgManagement.populateLongituteLatitude(locationPoint);
        } 
            ...
            orgManagement.populateLongituteLatitude(locationPoint);
                   ...
                   else if (userProcessContainer.getComponent(componentArray.length - 1) instanceof LocalitySetUpInformation) {
            LocalitySetUpInformation orgManagement = (LocalitySetUpInformation) userProcessContainer.getComponent(componentArray.length - 1);
            orgManagement.populateLongituteLatitude(locationPoint);
        } 
    ...
    private void jXMapViewerMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jXMapViewerMousePressed
        ...
        //x.setArea();
                ...
                //ecoSystem.setAreaPoint(locationPoint);
  ...
  private void init() {
        ...
        //jXMapViewer.setArea(WIDTH, WIDTH);
