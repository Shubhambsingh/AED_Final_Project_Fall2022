 ...
 * @author ShubhamSingh
 */
public class ManageLocalityShelterReqJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageLocalityShelterReqJPanel
     */
    ...
    EcoSystem ecoSystem;
    public ManageLocalityShelterReqJPanel(JPanel userProcessContainer,
            UserDetails userAccount,
            OrganizationDirectory organizationDirectory,
            Enterprise enterprise,
            EcoSystem ecoSystem) {
    ...
    private void btnAssignToMeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToMeActionPerformed
        ...
        if(selectedRow<0){
            ...
            LocalityShelterRequest c =  (LocalityShelterRequest)tblRequestTableLocality.getValueAt(selectedRow, 5);
            c.setStatus("Pending");
    ...
    private void btnApproveReqHospitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveReqHospitalActionPerformed
      ...
      int selectedRow= tblRequestTableLocality.getSelectedRow();
        if(selectedRow<0){
            ...
            LocalityShelterRequest p=(LocalityShelterRequest) tblRequestTableLocality.getValueAt(selectedRow, 5);
            ...
            if(p.getReceiver()!= null){
                if (p.getStatus().equalsIgnoreCase("Pending")) {
                    ...
                    if(ecoSystem.getShelterDirectory().getShelterList().size()<= 0){
                        JOptionPane.showMessageDialog(null, "No Meal available.");
                        return;
                    }
                    for (Shelter shelter : ecoSystem.getShelterDirectory().getShelterList()) {
 ...
 private void fillTheRequestedTable() {
        ...
        for(WorkRequest work : ecoSystem.getWorkQueue().getWorkRequestList()){
            if(work instanceof LocalityShelterRequest){
                ...
                if(((LocalityShelterRequest) work).getReceiver() == null || ((LocalityShelterRequest) work).getReceiver() == userAccount){
             ...
             Object[] row = new Object[8];
                ...
                row[6] = ((LocalityShelterRequest) work).getSender();
                
                if(((LocalityShelterRequest) work).getReceiver()!=null){
                row[7] = ((LocalityShelterRequest) work).getReceiver();
                }
                model.addRow(row);
            }
